...
# rfm["recency"] = (analysis_date - df["last_order_date"]).astype('timedelta64[D]')  rfm tanımı
# cltv_df["recency_cltv_weekly"] = ((df["last_order_date"] - df["first_order_date"]).astype('timedelta64[D]')) / 7  cltv tanımı
cltv_df.head()
